<template>
    <div
        ...
        aria-hidden="true"
        aria-labelledby="editFolderLabel"
        tabindex="-1"
      >
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="editFolderLabel">
                Editar Pasta
              </h1>
              <button
                type="button"
              ...
              <div class="container">
                <form class="row">
                  <div class="col-12 mt-2">
                    <label for="tituloPasta" class="form-label"
                      >Título</label
                    >
                    <input
                      type="text"
                  ...
                  <div class="col-12 mt-2">
                    <label for="tipoPasta" class="form-label">Tipo</label>
      ...
      <option value="videos">Vídeos</option>
                  ...
                  <div class="col-12 mt-2">
                    <label for="descricaoPasta" class="form-label"
                      >Descrição</label
                    >
