    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content rounded-2 modalText">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="editTextModalLabel">Editar Texto</h1>
          ...
          <div class="container_form">
            <form class="row g-2" id="form">
              ...
              <div class="col-12">
                ...
                <textarea class="form-control rounded-0" rows="2" id="description"></textarea>
              </div>
              <div class="col-12">
                <label for="text" class="form-label">Texto</label>
                <textarea class="form-control rounded-0" rows="10" id="text"></textarea>
              </div>
              <div class="col-12 text-center pt-3 d-flex justify-content-center">
                <ButtonCancel :text="textCancel" :dismiss="dismiss" />
                <ButtonGreen :text="textSave" />
              </div>
            </form>
          </div>
        </div>
